...
import { faDragon, faBell, faSignInAlt, faEnvelope } from '@fortawesome/free-solid-svg-icons';
...
const Navbar = ({ toggleSidebar }) => {
  ...
  return (
    <div className="w-full sidebar border-b text-[#838383] dark:text-opacity-35 border-gray-300 border-opacity-10 shadow-md flex items-center justify-between px-4 lg:px-7 h-[60px]">
